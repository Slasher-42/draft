...
export function DashboardHeader() {
  ...
  const pageTitleMap: Record<string, string> = {
    ...
    "/startup/account":             t("account"),
    "/startup/meetups":             t("meetups"),
    "/startup/contracts":           t("contracts"),
    "/startup/collaborators":       t("collaborators"),
    "/investor/executions":         t("myInvestments"),
    "/investor/execute":            t("newInvestmentExecution"),
    "/investor/ai":                 t("aiAssessment"),
    "/investor/account":            t("account"),
    "/investor/meetups":            t("meetups"),
    "/investor/contracts":          t("contracts"),
    "/investor/collaborators":      t("collaborators"),
